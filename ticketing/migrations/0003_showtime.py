    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('salable_seate', models.IntegerField()),
                ('free_eats', models.IntegerField()),
                ('status', models.IntegerField(choices=[(1, 'فروش آغاز نشد'), (2, 'در حال فروش بلیت'), (3, 'بلیت ها تمام شد'), (4, 'فروش بلیت بسته شد'), (5, 'فیلم پخش شد'), (6, 'سانس لغو شد')])),
